...
echo ssh -o StrictHostKeyChecking=no -i ssh_keys/gse_admin opc@${gse_admin} 'ssh -o StrictHostKeyChecking=no -i '${gse_admin_stagedir}'/'${identity_domain}' opc@'${target_ip}' "sudo mkdir -p '${gse_admin_stagedir}' && sudo chown oracle:oinstall -R '${gse_admin_stagedir}' && sudo chmod 777 -R '${gse_admin_stagedir}'"'
ssh -o StrictHostKeyChecking=no -i ssh_keys/gse_admin opc@${gse_admin} 'ssh -o StrictHostKeyChecking=no -i '${gse_admin_stagedir}'/'${identity_domain}' opc@'${target_ip}' "sudo mkdir -p '${gse_admin_stagedir}' && sudo chown oracle:oinstall -R '${gse_admin_stagedir}' && sudo chmod 777 -R '${gse_admin_stagedir}'"'
