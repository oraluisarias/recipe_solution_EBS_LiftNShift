...
scp -o StrictHostKeyChecking=no -o StrictHostKeyChecking=no  -i ssh_keys/gse_admin ssh_keys/${identity_domain} scripts/ebs_workshop.sh scripts/p22336899_R12_GENERIC.zip opc@${gse_admin}:~/
